...
class AlumnosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create alumno" do
    assert_difference("Alumno.count") do
      post alumnos_url, params: { alumno: { calificacion: @alumno.calificacion, nombre: @alumno.nombre, trabajo: @alumno.trabajo } }
    end
  ...
  test "should update alumno" do
    patch alumno_url(@alumno), params: { alumno: { calificacion: @alumno.calificacion, nombre: @alumno.nombre, trabajo: @alumno.trabajo } }
